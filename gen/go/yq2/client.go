...
// APIClient manages communication with the Yahoo Finance API v1.0.9
...
func selectHeaderCookie(cookies map[string]string) string {
	if len(cookies) == 0 {
		return ""
	}
	...
	for k, v := range cookies {
		...
		cookieValues += fmt.Sprintf("%s=%s", k, v)
	}
